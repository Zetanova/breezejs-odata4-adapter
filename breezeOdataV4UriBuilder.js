/**
 * An experimental uriBuilder to allow BreezeJS to work with an OData v4 server.
 *
 * Created by Zetanova on 20/12/2014.
 */
(function (factory) {
    if (breeze) {
        factory(breeze);
    ...
    proto.buildUri = function (entityQuery, metadataStore) {
        ...
        //hack: add support for paramters including odata4 $search
        core.objectForEach(entityQuery.parameters, function (k, v) {
            queryOptions[k] = v;
        });
